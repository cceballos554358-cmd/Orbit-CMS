        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="auth()->user()->isAdmin() ? route('admin.articles.index') : (auth()->user()->isEditor() ? route('editor.articles.index') : route('author.articles.index'))" 
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <span class="mr-3 text-xs px-2 py-1 bg-gray-200 text-gray-700 rounded-full uppercase font-bold tracking-wider">
                    {{ auth()->user()->role }}
                </span>
